...
@Module({
  imports: [
    ...
    SequelizeModule.forRoot({
      ...
      models:[Language,EventType,HumanCategory,VenueType,Venue,Event,Region,District,Seat,Ticket,SeatType,TicketType,Country,Customer,CustomerAdress,Flat,Gender,Discount,DeliveryMethod,PaymentMethod,Booking,CustomerCard,Admin,Cart,Status],
      autoLoadModels:true,
      logging:false
    }),
    
    LanguageModule, EventTypeModule, HumanCategoryModule, VenueTypeModule, VenueModule, EventModule, RegionModule, DistrictModule, SeatTypeModule, SeatModule, TicketModule, TicketTypeModule, CustomerModule, CustomerAdressModule, GenderModule, CountryModule, FlatModule, AdminModule, CustomerCardModule, CartModule, BookingModule, PaymentMethodModule, DeliveryMethodModule, StatusModule, DiscountModule, SectorModule, FilesModule],
